...
export default function Home() {
  ...
  useEffect(() => {
    fetch("https://phim.nguonc.com/api/films/danh-sach/phim-le?page=2")
      .then((response) => response.json())
      .then((data) => {
  ...
  useEffect(() => {
    fetch("https://phim.nguonc.com/api/films/danh-sach/phim-bo?page=2")
      .then((response) => response.json())
      .then((data) => {
  ...
  useEffect(() => {
    fetch("https://phim.nguonc.com/api/films/danh-sach/hoat-hinh?page=2")
      .then((response) => response.json())
      .then((data) => {
  ...
  useEffect(() => {
    fetch("https://phim.nguonc.com/api/films/danh-sach/phim-dang-chieu?page=2")
      .then((response) => response.json())
      .then((data) => {
  ...
  useEffect(() => {
    fetch("https://phim.nguonc.com/api/films/danh-sach/tv-shows?page=2")
      .then((response) => response.json())
      .then((data) => {
  ...
  return (
    <div>
      ...
      <div className="slider-container">
        <div className="title fw text-warning d-flex justify-content-between">
          <div><i className="fe fe-hash"></i><span> PHIM MỚI NHẤT </span></div>
          <div><i className="fe fe-hash"></i><a href="/phim-moi-nhat" className="text-warning"> XEM THÊM </a></div>
        </div>
            ...
            <div key={index} className="col-6 col-sm-4 col-lg-3 col-xl-2 ">
              <div className="card text-center bg-none mt-1" style={{ padding: 10 }}>
                <a href={`/phim/${movie.slug}`} className="card__cover">
                  <img loading="lazy" src={movie.thumb_url} alt={movie.name} height={260} />
      ...
      <div className="slider-container mt-6">
        <div className="title fw text-warning">
          <i className="fe fe-hash"></i><span> PHIM LẺ </span>
        </div>
        <Slider {...settings} className="row">
      ...
      <div className="slider-container mt-6">
        <div className="title fw text-warning">
          <i className="fe fe-hash"></i><span> PHIM BỘ </span>
        </div>
        <Slider {...settings} className="row">
      ...
      <div className="slider-container mt-6">
        <div className="title fw text-warning">
          <i className="fe fe-hash"></i><span> PHIM HOẠT HÌNH </span>
        </div>
        <Slider {...settings} className="row">
          {phimHoatHinh.map((movie, index) => (
            <div key={index} className="col-6 col-sm-4 col-lg-3 col-xl-2 ">
              <div className="card text-center bg-none mt-1" style={{ padding: 10 }}>
                <a href={`/phim/${movie.slug}`} className="card__cover">
                  <img loading="lazy" src={movie.thumb_url} alt={movie.name} height={260} />
      ...
      <div className="slider-container mt-6">
        <div className="title fw text-warning">
          <i className="fe fe-hash"></i><span> PHIM ĐANG CHIẾU </span>
        </div>
        <Slider {...settings} className="row">
      ...
      <div className="slider-container mt-6">
        <div className="title fw text-warning">
          <i className="fe fe-hash"></i><span> TV SHOW </span>
        </div>
        <Slider {...settings} className="row">
